      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="shadow-soft">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-overline">Total Submissions</p>
                <p className="text-stat">{totalSubmissions}</p>
              </div>
        ...
        <Card className="shadow-soft">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-overline">Under Review</p>
                <p className="text-stat">{pendingSubmissions}</p>
              </div>
        ...
        <Card className="shadow-soft">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-overline">Published</p>
                <p className="text-stat">{acceptedSubmissions}</p>
              </div>
        ...
        {isReviewer && (
          <Card className="shadow-soft">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-overline">Reviews Completed</p>
                  <p className="text-stat">{completedReviews}</p>
                </div>
                <div className="p-3 bg-primary/10 rounded-full">
        ...
        <Card className="shadow-elegant">
          <CardHeader className="border-b">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-h4">Professional Summary</CardTitle>
                <CardDescription className="text-body-sm">Your medical credentials and expertise</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="pt-6">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              {doctorProfile.academic_degree && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-overline">Degree</p>
              ...
              {doctorProfile.research_interests && doctorProfile.research_interests.length > 0 && (
                <div className="flex items-start gap-3 md:col-span-2 lg:col-span-3">
                  ...
                  <div>
                    <p className="text-overline mb-2">Research Interests</p>
            ...
            {!doctorProfile.specialty && (
              <div className="text-center py-6">
                <p className="text-body-sm">Complete your professional profile to showcase your expertise</p>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-primary/10 rounded-lg">
                  ...
                  <CardTitle className="text-h4">Recent Submissions</CardTitle>
              </div>
          ...
          <CardContent className="pt-4">
            {submissions && submissions.length > 0 ? (
              <div className="space-y-3">
                {submissions.slice(0, 3).map((submission) => (
                  <div key={submission.id} className="flex items-center justify-between py-2 border-b last:border-0">
                    <div className="flex-1 min-w-0">
                        <p className="text-body font-medium truncate">{submission.title}</p>
                ...
                <div className="text-center py-6 text-body-sm">
            ...
            <CardHeader className="border-b">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-h4">Recent Reviews</CardTitle>
                </div>
                <Button asChild variant="ghost" size="sm">
                ...
                <div className="space-y-3">
                  {reviews.slice(0, 3).map((review) => (
                    <div key={review.id} className="flex items-center justify-between py-2 border-b last:border-0">
                      <div className="flex-1 min-w-0">
                        <p className="text-body font-medium truncate">Review #{review.id.slice(0, 8)}</p>
                        <p className="text-caption">
