...
const map: Record<string, { label: string; tone: Tone; icon: LucideIcon }> = {
  ...
  technical_check: { label: "Technical Check", tone: "warning", icon: FileEdit },
  editorial_assessment: { label: "Editorial Assessment", tone: "info", icon: Eye },
  editor_assigned: { label: "Editor Assigned", tone: "info", icon: Eye },
  reviewer_invitation: { label: "Reviewer Invitation", tone: "warning", icon: Clock },
  peer_review: { label: "Peer Review", tone: "info", icon: Eye },
  re_review: { label: "Re-review", tone: "info", icon: Eye },
  decision_pending: { label: "Decision Pending", tone: "warning", icon: Clock },
  proof: { label: "Proof", tone: "warning", icon: FileEdit },
